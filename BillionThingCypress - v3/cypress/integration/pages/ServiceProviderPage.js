...
class ServiceProviderPage
{
    ...
    {
        const field = cy.get(':nth-child(2) > .col-lg-7 > .form-control')
        field.type(value)
        return this
    }
    ...
    {
        const field = cy.get(':nth-child(3) > .col-lg-7 > .form-control')
        field.type(value)
        return this
    }
    ...
    {
        const field = cy.get(':nth-child(4) > .col-lg-7 > .form-control')
        field.type(value)
        return this
    }
    ...
    fillUid(value)
    {
        const field = cy.get(':nth-child(5) > .col-lg-7 > .form-control')
        field.type(value)
        return this
    }
