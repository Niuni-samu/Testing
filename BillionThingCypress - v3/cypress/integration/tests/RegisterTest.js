...
describe('Billionthing Register Test', function()  {
    ...
    it('Register New user', function()  {
        ...
        cy
            ...
            registerpage.signup()
            cy.get('#h1').should('contain',registervalid.SuccessTitle)
     ...
     it('Register with existing username & email', function()  {
        ...
        cy
            ...
            registerpage.agreeCheckbox()
            registerpage.signup()
            cy.get(':nth-child(2) > app-validation-message > div > .text-danger').should('contain',registerExistUsename.ExistingUsernameMessage)
